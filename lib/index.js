...
const RNKitCodePushModule = NativeModules.RNKitCodePush
...
export default class RNKitCodePush {
  ...
  addEventForDownloadProgressListener(callback = ()=>{}) {
    this.downloadListener = codePushEventEmitter.addListener('RNKitCodePushDownloadProgress', callback);
  }

  removeEventForDownloadProgressListener() {
    this.downloadListener && this.downloadListener.remove()
  }

  addEventForUnzipListener(callback = ()=>{}) {
    this.unzipListener = codePushEventEmitter.addListener('RNKitCodePushUnzipProgress', callback);
  }

  removeEventForUnzipListener() {
